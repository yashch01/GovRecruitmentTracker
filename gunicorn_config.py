...
Optimized for cloud container environments (Render, Railway, Fly.io, Heroku):
  - Automatically binds to $PORT provided by container runtime.
  ...
  - Graceful timeout handling for background scraper thread dispatching.
"""
...
# ── Server Socket ─────────────────────────────────────────────────────────────
# Render and Heroku inject the $PORT environment variable
