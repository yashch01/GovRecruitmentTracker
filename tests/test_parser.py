...
# Pay extractor returns ₹ range when level text is not right next to 'pay level' keyword
# e.g. 'Pay: Level 6 (₹35,400 ...)' → extracts either Level 6 or the ₹ range — both valid
_assert(
...
# On 01/08/2025, person born 1998-04-15 is 27 years old → eligible
...
# On 01/08/2025, person born 1994-01-01 is 31 → barred
...
# On 01/08/2025, person born 1994-06-15 is 31 → with OBC +3 = max 31 → eligible
...
# On 01/08/2025, person born 1993-03-10 is 32 → with SC +5 = max 33 → eligible
...
# On 01/08/2025 = 35 years old, max 28+5=33 → barred
...
# On 01/01/2026, person born 1999-12-25 is 26 → eligible
...
# On 01/08/2025 = 26 years → eligible (uses upper bound 27)
